...
"""
                   # Tell Streamlit to use it
import os
os.environ["STREAMLIT_GLOBAL_DEVELOPMENT_MODE"] = "false"  # disable some metrics
os.makedirs("/content/.streamlit", exist_ok=True)
os.environ["HOME"] = "/content"  # point Streamlit to a writable folder
